...
export class SecretariaService {
  ...
  constructor() {
    ...
    this.turmasConfiguradas = this.storageService.carregar(this.turmasConfiguradasKey) ?? []
  }
  ...
  salvarTurma(nome, inicio, termino, diasDaSemana ) {
      if(this.buscarTurma(nome)) 
      this.turmasConfiguradas.push(new Turma(nome, inicio, termino, diasDaSemana))
      this._salvar()
  }
  ...
  _salvar() {
    try {
      ...
      this.storageService.salvar(this.turmasConfiguradasKey, this.turmasConfiguradas);
    } catch (error) {
